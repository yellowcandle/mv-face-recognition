...
def create_composite_image(original_path: Union[str, Path], result_path: Union[str, Path], 
    ...
    try:
        ...
        cv2.putText(composite, f"Similarity: {similarity:.2f}", 
                    (10, composite.shape[0] - 20), font, 0.7, (0, 255, 0), 2)
