...
def load_known_embeddings(
    ...
    if use_chromadb and HAS_CHROMADB:
        ...
        print(f"ChromaDB contains {chroma_recognizer.collection.count() if chroma_recognizer.collection else 0} embeddings")
...
def process_video(
    ...
    using_chromadb = hasattr(embeddings, 'match_face') and isinstance(embeddings, ChromaDBFaceRecognizer)
