...
class VideoManager:
    ...
    def __init__(self, cache_dir: str | None = None, enable_youtube: bool = True):
        """
    ...
    def _get_cache_directory(self, cache_dir: str | None = None) -> str:
    ...
    def get_video_info(self, video_name: str) -> dict | None:
    ...
    def get_video_path(self, video_name: str, download_if_missing: bool = True) -> str | None:
        """
    ...
    def _download_video(self, video_name: str) -> str | None:
...
def get_video_manager(cache_dir: str | None = None, enable_youtube: bool = True) -> VideoManager:
