...
class VideoDatasetManager:
    ...
    def _get_videos_from_fallback(self, quality: str) -> list[dict]:
        ...
        fallback_dirs.extend([
            "source/videos",              # Original directory
            f"dataset_staging/videos/{self.quality_configs[quality]['dir']}",  # Staging
            "source/videos_hf_optimized",  # Primary optimized (if exists)
            "source/videos_hf_clean"      # Clean versions (if exists)
        ])
    ...
    def get_video_path(self, video_id: str, quality: str = "720p") -> str | None:
        """
    ...
    def _check_cache(self, video_id: str, quality: str) -> str | None:
    ...
    def _download_from_dataset(self, video_id: str, quality: str) -> str | None:
    ...
    def _get_local_path(self, video_id: str, quality: str) -> str | None:
