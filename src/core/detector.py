...
class FaceDetector:
    ...
    def detect_faces(
        ...
        use_tracking = (
            ...
            self.tracking_method != self.TRACKING_NONE and
        ...
        if self.stats["frames_processed"] > 0:
            self.stats["avg_faces_per_frame"] = self.stats["detections"] / self.stats["frames_processed"]
    ...
    def _detect_faces_with_backend(
        ...
        if self.backend == self.BACKEND_OPENCV:
            ...
            for face in faces:
                ...
                bboxes.append(bbox if isinstance(bbox, (np.ndarray, np.generic)) else bbox)
