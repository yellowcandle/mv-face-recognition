...
def many_faces_image():
    ...
    for row in range(5):
        for col in range(10):  # 5x10 = 50 face-like regions
            ...
            cv2.ellipse(img, (x, y+15), (20, 10), 0, 0, 180, (200, 150, 100), -1)  # Mouth
        ...
        for row in range(4):  # 4x12 = 48 faces per frame
            for col in range(12):
                ...
                if x < 1150 and y < 750:  # Stay within bounds
                    ...
                    cv2.circle(img, (x+10, y-8), 5, (255, 255, 255), -1)  # Right eye
                    cv2.rectangle(img, (x-8, y+8), (x+8, y+15), (200, 150, 100), -1)  # Mouth
    ...
    for detection in detections[:20]:  # Test first 20 to avoid excessive runtime
        try:
            ...
            if hasattr(detection, 'embedding') or 'embedding' in detection:
                embedding = detection.embedding if hasattr(detection, 'embedding') else detection['embedding']
