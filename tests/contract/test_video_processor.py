...
def test_video_processor_uses_dependencies():
    ...
    has_detector = (hasattr(processor, 'detector') or 
                   hasattr(processor, 'face_detector') or
                   hasattr(processor, '_detector'))
    has_matcher = (hasattr(processor, 'matcher') or 
                  hasattr(processor, 'face_matcher') or
                  hasattr(processor, '_matcher'))
