...
from src.config.settings import SystemConfig, get_config, save_config
...
class TestConfig:
    ...
    def test_config_initialization(self):
        ...
        # Test UI defaults
        assert config.ui.enhanced_ui

        # Test storage defaults
        assert config.storage.cache_embeddings
    ...
    def test_config_serialization(self):
        ...
        assert not new_config.ui.enhanced_ui
    ...
    def test_get_config_from_file(self):
        ...
        try:
            ...
            with patch.dict('os.environ', {'CONFIG_PATH': config_path}):
                ...
                assert not config.recognition.use_gpu
                assert not config.ui.enhanced_ui
                assert config.storage.cache_embeddings
        finally:
    ...
    def test_save_config(self):
        ...
        try:
            ...
            with patch.dict('os.environ', {'CONFIG_PATH': config_path}):
                ...
                assert not saved_data["ui"]["enhanced_ui"]
        finally:
            Path(config_path).unlink()
            # Reset global config
            src.config.settings._config = None
