...
@pytest.fixture(scope="session")
def face_recognizer_arcface(
    face_detector_insightface,
):  # Depends on insightface detector for consistency
    ...
    try:
        ...
        recognizer = FaceRecognizer(
            face_detector=face_detector_insightface, similarity_threshold=0.6, use_arcface=True
        )
