...
class EnhancedEmbeddingGenerator:
    ...
    def generate_enhanced_embeddings(self):
        ...
        for contestant_id, info in self.contestants_info.items():
            try:
                ...
                if embeddings:
                    ...
                    success_count += 1
                    logger.info(f"Generated enhanced embedding for {info['nickname']} from {len(embeddings)} photos")
                else:
        ...
        logger.info(f"Enhanced embedding generation complete: {success_count} success, {error_count} errors")
