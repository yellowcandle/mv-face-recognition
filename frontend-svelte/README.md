# MV Face Recognition - Svelte Frontend

This is a complete rewrite of the original Vue.js frontend using Svelte and SvelteKit. The new frontend maintains all the functionality of the original while leveraging Svelte's reactive programming model and improved performance.
...
1. **Clone and navigate to the Svelte frontend**:
   ```bash
   cd frontend-svelte
   ```
...
**Note**: This Svelte frontend is a complete replacement for the Vue.js version and provides the same functionality with improved performance and developer experience.