            ...
            "Ivy So": {
                ...
                "frame_appearances": [
                    ...
                    },
                    {
                        "timestamp": 15.2,
                        "confidence": 0.92,
                        "bbox": [345, 125, 425, 205],
                    },
                    {
                        "timestamp": 18.7,
                        "confidence": 0.94,
                        "bbox": [350, 130, 430, 210],
                    },
                ],
            },
            "咖喱": {
                ...
                "frame_appearances": [
                    {
                        "timestamp": 25.1,
                        "confidence": 0.87,
                        "bbox": [560, 180, 640, 260],
                    },
                    {
                        "timestamp": 28.3,
                        "confidence": 0.91,
                        "bbox": [565, 185, 645, 265],
                    },
                ],
            },
            "Marf": {
...
async def get_processed_videos():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to fetch processed videos: {str(e)}"
        )
...
async def get_contestants_alt():
    ...
    try:
            ...
            contestants.append(
                {
                    ...
                    "photo_url": f"https://your-r2-domain.com/contestant_photos/{contestant['id']}.jpg"
                    if contestant["has_photos"]
                    else None,
                }
            )
        return contestants
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to fetch contestants: {str(e)}"
        )
...
async def get_video_faces(video_id: str, timestamp: float = None):
    ...
    try:
        ...
        if not metadata:
            raise HTTPException(
                status_code=404, detail="Face data not found for this video"
            )
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to fetch face data: {str(e)}"
        )
...
async def get_contestant_timeline(video_id: str, contestant_name: str):
    ...
    try:
        ...
        if not contestant_data:
            raise HTTPException(
                status_code=404,
                detail=f"Contestant {contestant_name} not found in video",
            )
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to fetch contestant timeline: {str(e)}"
        )
...
async def get_system_status():
    ...
    return {
        ...
        "storage": {"r2_connected": True, "kv_connected": True},
        "features": {
