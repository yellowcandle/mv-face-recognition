...
from app.models.schemas import AppSettings, FaceDetectionSettings, FaceMatchingSettings, VideoProcessingSettings
    ...
    async def get_settings(self) -> AppSettings:
        ...
        try:
            if self.config_file.exists():
                ...
                return AppSettings(
                    face_detection=FaceDetectionSettings(**config.get('face_detection', {})),
                    face_matching=FaceMatchingSettings(**config.get('face_matching', {})),
                    video_processing=VideoProcessingSettings(**config.get('video_processing', {}))
                )
            else:
