...
def regenerate_embeddings():
    ...
    logger.info(f"Contestants: {list(contestant_db.contestant_names[:10])}...")  # Show first 10
    ...
    print("="*50)
    print(f"✅ Loaded face recognition system")
...
def list_photo_directories():
    ...
    print(f"   Range: {min(numbered_dirs) if numbered_dirs else 'N/A'} to {max(numbered_dirs) if numbered_dirs else 'N/A'}")
