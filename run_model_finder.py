...
def main():
    # Parse arguments
    parser = argparse.ArgumentParser(description="Run Model Finder to discover face recognition models")
    parser.add_argument("--force", action="store_true", help="Force re-download of models")
    parser.add_argument("--search-packages", action="store_true", help="Search installed packages for models")
    parser.add_argument("--recognition-only", action="store_true", help="Only find recognition models")
            ...
            for common_path in common_paths:
                ...
                if os.path.exists(full_path):
                    ...
                    for file in os.listdir(full_path):
                        if file.endswith((".onnx", ".pb", ".pth", ".caffemodel", ".prototxt", ".bin")):
                            print(f"  - {file}")
