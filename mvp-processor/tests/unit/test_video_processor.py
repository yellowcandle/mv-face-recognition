...
class TestVideoProcessor:
    ...
    def test_create_thumbnail(self, sample_config, sample_video, temp_dir):
        ...
        result_path = processor.create_thumbnail(sample_video, thumbnail_path, timestamp=0.5)
    ...
    def test_create_thumbnail_invalid_timestamp(self, sample_config, sample_video, temp_dir):
...
class TestFrameProcessor:
    ...
    def test_preprocess_frame(self, sample_image):
        ...
        assert not np.array_equal(rgb_frame, frame)  # Should be different due to BGR->RGB conversion
    ...
    def test_draw_face_box(self, sample_image):
        ...
        result_frame = FrameProcessor.draw_face_box(frame, face_location, label, confidence)
...
class TestVideoProcessorIntegration:
    ...
    def test_full_video_processing_pipeline(self, sample_config, sample_video, temp_dir):
