...
class CloudflareUploader:
    ...
    def _initialize_r2_client(self):
        ...
        try:
            ...
            logger.error("Make sure CLOUDFLARE_R2_ACCESS_KEY_ID and CLOUDFLARE_R2_SECRET_ACCESS_KEY are set")
            raise
    ...
    def upload_package(self, upload_package: Dict):
        ...
        try:
            ...
            self._upload_videos(upload_package['processed_videos'], upload_package['video_info'])
            
            # 2. Upload thumbnail
            self._upload_thumbnail(upload_package['thumbnail'], upload_package['video_info'])
        ...
        for prefix in prefixes:
            try:
                ...
                if objects_to_delete:
                    ...
                    logger.info(f"Deleted {len(objects_to_delete)} objects with prefix: {prefix}")
